...
export class Parameter {
    ...
    equal(other: Parameter) {
        return this.identifier === other.identifier && this.typeParameter === other.typeParameter && this.pos.equals(other.pos)
    }
}
export class FunctionNode extends SourceCodeNode {
    readonly parameters: Array<Parameter> = [];
    constructor(name: string, parent: Node, pos: Position, parameters: Array<Parameter>, idNumber: number) {
        super(name, parent, pos, NodeType.Function, idNumber);
